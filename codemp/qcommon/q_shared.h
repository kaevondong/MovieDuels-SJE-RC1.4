...
#define PRODUCT_NAME			"MovieDuelsconfig"

#define CLIENT_WINDOW_TITLE "MovieDuels MP"
#define CLIENT_CONSOLE_TITLE "MovieDuels MP Console"
#define HOMEPATH_NAME_UNIX "MovieDuels"
