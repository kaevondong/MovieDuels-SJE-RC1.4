...
stringID_table_t SaberMoveTable[] =
{
	...
	// Parries MD Mode
	ENUM2STRING(LS_PARRY_UP_MD),
	ENUM2STRING(LS_PARRY_UR_MD),
	ENUM2STRING(LS_PARRY_UL_MD),
	ENUM2STRING(LS_PARRY_LR_MD),
	ENUM2STRING(LS_PARRY_LL_MD),		
	ENUM2STRING(LS_PARRY_BACK),
		
	// Projectile Reflections MD Mode
	ENUM2STRING(LS_REFLECT_UP_MD),//
	ENUM2STRING(LS_REFLECT_UR_MD),	
	ENUM2STRING(LS_REFLECT_UL_MD),
	ENUM2STRING(LS_REFLECT_LR_MD),
	ENUM2STRING(LS_REFLECT_LL_MD),
