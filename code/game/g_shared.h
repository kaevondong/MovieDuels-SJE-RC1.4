...
#define	MAX_CUSTOM_JEDI_SOUNDS	24
...
typedef enum {
	...
	BLOCKED_TOP_PROJ,
	//MD Mode blocking
	BLOCKED_UPPER_RIGHT_MD,
	BLOCKED_UPPER_LEFT_MD,
	BLOCKED_LOWER_RIGHT_MD,
	BLOCKED_LOWER_LEFT_MD,
	BLOCKED_TOP_MD,
	BLOCKED_BACK
...
public:
		...
		ojk::SavedGameHelper& saved_game) const
	{
		...
		saved_game.write<int32_t>(lastkilled_client);
		...
		ojk::SavedGameHelper& saved_game)
	{
		...
		saved_game.read<int32_t>(lastkilled_client);
