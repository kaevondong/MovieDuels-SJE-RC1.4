...
#define FATIGUE_AUTOBOLTBLOCK	7
#define FATIGUE_ATTACKFAKE		2
#define FATIGUE_DODGE   		50
#define FATIGUE_DODGEING   		35
#define FATIGUE_DODGEINGBOT   	70
#define FATIGUE_AUTOSABERBOLTBLOCK	2
...
#define FLAG_DASHING    	15
#define FLAG_ATTACKFATIGUE 	16
#define FLAG_NPCBLOCKING 	17

#define DODGE_BOLTBLOCK			5	//standard DP cost to block a missile bolt
#define DODGE_BOWCASTERBLOCK	7
#define DODGE_TUSKENBLOCK	    9
...
#define BLASTERMISHAPLEVEL_MAXINACCURACY   5
...
#define MAX_RETURN_TIME 2000

#define FATIGUE_KILLBONUS      30 //the bonus you get for killing another player
#define FATIGUE_NPCDAMAGEBONUS 30 //the bonus you get for slapping another player
#define FATIGUE_DAMAGEBONUS    20 //the bonus you get for slapping another player
#define FATIGUE_HURTBONUSMAX   15 //the bonus you get for hurting another player alot
#define FATIGUE_HURTBONUS      10  //the bonus you get for hurting another player
#define FATIGUE_HURTBONUSMIN   5  //the bonus you get for hurting another player a small amount
...
#define	PMF_USE_HELD		(1<<20)//32768	// Holding down the attack button
#define	PMF_BLOCK_HELD		(1<<21)//32768	// Holding down the attack button
...
#define EF_WALK         		0x100000000	

#define	EF_MEDITATING   	     0x00000008		// draw an excellent sprite
...
#define PW_REMOVE_AT_DEATH ((1<<PW_MEDITATE)|(1<<PW_BATTLESUIT)|(1<<PW_HASTE)|(1<<PW_CLOAKED)|(1<<PW_UNCLOAKING)|(1<<PW_UNCLOAKING)|(1<<PW_GALAK_SHIELD)|(1<<PW_DISINT_2)|(1<<PW_INVINCIBLE)|(1<<PW_SEEKER))
