...
typedef enum //# animNumber_e
{
	...
	BOTH_DEATHBACKWARD3,	//# Second Death in which they get thrown backward
	...
	BOTH_ATTACKJANGO,		//# Attack with one-handed pistol
...
//===End Saber locks==================================================================
	...
	BOTH_A2_STABBACK1B,		//# Stab backhandsaber backward
	...
	BOTH_DOOKU_FULLDRAW,	//# Transition from stand1 to stand2 ALT
	BOTH_DOOKU_SMALLDRAW,	//# Transition from stand1 to stand2 ALT
	BOTH_STAND1TO2_ALT,		//# Transition from stand1 to stand2 ALT
	BOTH_STAND1TO3_ALT,		//# Transition from stand1 to stand3 ALT
	...
	BOTH_CROUCHDODGE,			//# Transition from standing to crouch
	...
	BOTH_JUMP2,				//# Jump - wind-up and leave ground
	...
	BOTH_FORCEJUMP2,		//# Jump - wind-up and leave ground
	...
	BOTH_BLOCK_FL,			//# lean-dodge forward left
	BOTH_BLOCK_FR,			//# lean-dodge forward right
	BOTH_BLOCK_BL,			//# lean-dodge backwards left
	BOTH_BLOCK_BR,			//# lean-dodge backwards right
	BOTH_BLOCK_L,			//# lean-dodge left
	BOTH_BLOCK_R,			//# lean-dodge right
	BOTH_BLOCK_HOLD_FL,			//# lean-dodge pose forward left
	BOTH_BLOCK_HOLD_FR,			//# lean-dodge pose forward right
	BOTH_BLOCK_HOLD_BL,			//# lean-dodge pose backwards left
	BOTH_BLOCK_HOLD_BR,			//# lean-dodge pose backwards right
	BOTH_BLOCK_HOLD_L,			//# lean-dodge pose left
	BOTH_BLOCK_HOLD_R,			//# lean-dodge pose right
	...
	//Alora			
	BOTH_ALORA_SPIN_MD2,		//#jump spin attack	death ballet	
	BOTH_ALORA_FLIP_1_MD2,		//# gymnast move 1		
	BOTH_ALORA_FLIP_2_MD2,		//# gymnast move 2		
	BOTH_ALORA_FLIP_3_MD2,		//# gymnast move3		
	BOTH_ALORA_FLIP_B_MD2,		//# gymnast move back		
	BOTH_ALORA_SPIN_THROW_MD2,	//# dual saber throw		
	BOTH_ALORA_SPIN_SLASH_MD2,	//# spin slash	special bonus animation!! :)	
	BOTH_ALORA_TAUNT_MD2,		//# special taunt		
	...
	BOTH_P1_S1_T1_,	//# Block shot/saber top

	BOTH_P1_S1_B_,		//[backblock]sp
	BOTH_P6_S1_B_,		//[backblock]sp
	BOTH_P7_S1_B_,		//[backblock]sp

	BOTH_P1_S1_B1_,		//[backblock]mp
	BOTH_P6_S1_B1_,		//[backblock]mp
	BOTH_P7_S1_B1_,		//[backblock]mp

	BOTH_GRIEVOUS_SPIN,
	BOTH_FLAMETHROWER,		//[MAND_FLAME]
	BOTH_WOOKIE_SLAP,		//[wookie meele]
	BOTH_FORCE_2HANDEDLIGHTNING_OLD,		//LEVEL 1 LIGHTNING //OLD ORIGONAL
	BOTH_FORCE_2HANDEDLIGHTNING_NEW,		//LEVEL 1 LIGHTNING //OLD ORIGONAL
	BOTH_2HANDPUSH,		//
	BOTH_WALKBACK_OLD2,		//
	BOTH_FORCEGRIP_OLD,		//
	//SBD ANIMS
	SBD_WALK_NORMAL,	//SBD ANIMS
	SBD_WALKBACK_NORMAL,
	SBD_WALK_WEAPON,
	SBD_RUNBACK_NORMAL,
	SBD_RUNING_WEAPON,
	...
	BOTH_MANUAL_R,
	//[/MLDODGE]
	BOTH_ROLL_F1,//shortroll
	BOTH_ROLL_F2,//baseroll
	BOTH_DODGE_B,
	BOTH_MEDITATE1,
	BOTH_MEDITATE_END1,

	BOTH_FORCELONGLEAP_ATTACK2,//slower version for mp
	BOTH_FORCELONGLEAP_LAND2,//faster for mp
	...
	BOTH_A4_SPECIAL,//palpatine attack
	BOTH_A5_SPECIAL,//parrytest attack

	BOTH_WALK2B,				//# Normal walk
	BOTH_SPRINT,				//# Full gunners sprint

	BOTH_DOWNTOPRONE,			    //Prone down
	BOTH_STANDFROMPRONE,			//Prone up
	BOTH_PRONEIDLE,			        //Prone idle
	BOTH_FIREPRONE,			        //Prone fire

	BOTH_LEOPARDCRAWL,			    //leopard crawl
	BOTH_LEOPARDCRAWLBACK,			//leopard crawl
	BOTH_LEOPARDCRAWLLEFT,			//leopard crawl
	BOTH_LEOPARDCRAWLRIGHT,			//leopard crawl

	BOTH_STANDMELEE,		//# Standing idle, WITH MELEE

	BOTH_ATTACK12,			//# "Attack" prone
	BOTH_FLIP_F2,			//# Flip forward
	BOTH_LAND3,				//# Landing Hard (from a great height)
	BOTH_A7_KICK_F2,
	BOTH_RESISTPUSH2,		//# plant yourself to resist force push/pulls.
	BOTH_CROUCH2,			//# Transition from standing to crouch with melee
	BOTH_WALK8,				//# pistolwalk
	BOTH_WALK9,				//# riflewalk
	BOTH_WALK10,			//# grenadewalk
	BOTH_WALK25,			//# Galak_walk
	BOTH_RUN3,				//# Full riflerun
	BOTH_RUN5,				//# pistol Run
	BOTH_RUN6,				//# Thermal run
	BOTH_RUN7,				//# Low health run
	BOTH_RUN8,				//# near death single and staff run
	BOTH_RUN9,				//# near death SABER run
	BOTH_RUN10,				//# near death dual run

	BOTH_MELEEUP,			//# THIRED melee attack
	...
	BOTH_LIFTED1,			//# Fits with ENUM2STRING(BOTH_LIFT1), lifted on shoulder
	BOTH_CARRIED1,			//# Fits with ENUM2STRING(TORSO_CARRY1), carried over shoulder
	BOTH_CARRIED2,			//# Laying over object

	BOTH_SUPERPUSH,
	BOTH_MELEE3,			//# FOURTH melee attack
	...
	BOTH_KISSEE1START2,		//# Jan start2 being kissed
	...
	BOTH_AXE1,//AXE TOP RIGHT TO BOTTOM LEFT
	BOTH_AXE2,//AXE RIGHT TO LEFT

	BOTH_AXE3,//AXE TOP LEFT TO BOTTOM RIGHT
	BOTH_AXE4,//AXE LEFT TO RIGHT
	...
	BOTH_BACKHAND_T__B_,	//# Fast weak vertical attack top to bottom
	BOTH_BACKHAND__R__L,	//# Fast weak horizontal attack right to left
	BOTH_BACKHAND_BR_TL,	//# Fast weak diagonal attack top left to botom right
	BOTH_BACKHAND_TR_BL,	//# Fast weak diagonal attack bottom left to right	
	BOTH_SABERDUAL_BHSABERS_STANCE,	//# dual backhand saber stance	
	BOTH_BLOCK_BACK_HAND,	//# backhand saber block	

	BOTH_SABER_IGNITION,	//# basic saber ignition
	BOTH_SABER_IGNITION_JFA,	//# Jedi fallen Order saber ignition
	...
	BOTH_P6_S6_TG_,//Grievous top block
	...
	BOTH_MD_CIN_1,		//# Level specific cinematic 1
	BOTH_MD_CIN_2,		//# Level specific cinematic 2
	BOTH_MD_CIN_3,		//# Level specific cinematic 3
	BOTH_MD_CIN_4,		//# Level specific cinematic 4
	BOTH_MD_CIN_5,		//# Level specific cinematic 5
	BOTH_MD_CIN_6,		//# Level specific cinematic 6
	BOTH_MD_CIN_7,		//# Level specific cinematic 7
	BOTH_MD_CIN_8,		//# Level specific cinematic 8
	BOTH_MD_CIN_9,		//# Level specific cinematic 9
	BOTH_MD_CIN_10,		//# Level specific cinematic 10
	BOTH_MD_CIN_11,		//# Level specific cinematic 11
	BOTH_MD_CIN_12,		//# Level specific cinematic 12
	BOTH_MD_CIN_13,		//# Level specific cinematic 13
	BOTH_MD_CIN_14,		//# Level specific cinematic 14
	BOTH_MD_CIN_15,		//# Level specific cinematic 15
	BOTH_MD_CIN_16,		//# Level specific cinematic 16
	BOTH_MD_CIN_17,		//# Level specific cinematic 17
	BOTH_MD_CIN_18,		//# Level specific cinematic 18
	BOTH_MD_CIN_19,		//# Level specific cinematic 19
	BOTH_MD_CIN_20,		//# Level specific cinematic 20
	BOTH_MD_CIN_21,		//# Level specific cinematic 21
	BOTH_MD_CIN_22,		//# Level specific cinematic 22
	BOTH_MD_CIN_23,		//# Level specific cinematic 23
	BOTH_MD_CIN_24,		//# Level specific cinematic 24
	BOTH_MD_CIN_25,		//# Level specific cinematic 25

	BOTH_MD_CIN_26,		//# Level specific cinematic
	BOTH_MD_CIN_27,		//# Level specific cinematic
	BOTH_MD_CIN_28,		//# Level specific cinematic
	BOTH_MD_CIN_29,		//# Level specific cinematic
	BOTH_MD_CIN_30,		//# Level specific cinematic
	BOTH_MD_CIN_31,		//# Level specific cinematic
	BOTH_MD_CIN_32,		//# Level specific cinematic
	BOTH_MD_CIN_33,		//# Level specific cinematic
	BOTH_MD_CIN_34,		//# Level specific cinematic
	BOTH_MD_CIN_35,		//# Level specific cinematic
	BOTH_MD_CIN_36,		//# Level specific cinematic
	BOTH_MD_CIN_37,		//# Level specific cinematic
	BOTH_MD_CIN_38,		//# Level specific cinematic
	BOTH_MD_CIN_39,		//# Level specific cinematic
	BOTH_MD_CIN_40,		//# Level specific cinematic
	BOTH_MD_CIN_41,		//# Level specific cinematic
	BOTH_MD_CIN_42,		//# Level specific cinematic
	BOTH_MD_CIN_43,		//# Level specific cinematic
	BOTH_MD_CIN_44,		//# Level specific cinematic
	BOTH_MD_CIN_45,		//# Level specific cinematic
	BOTH_MD_CIN_46,		//# Level specific cinematic
	BOTH_MD_CIN_47,		//# Level specific cinematic
	BOTH_MD_CIN_48,		//# Level specific cinematic
	BOTH_MD_CIN_49,		//# Level specific cinematic
	BOTH_MD_CIN_50,		//# Level specific cinematic
	...
	BOTH_P1_S1_BL_MD,	//# Block shot/saber bottom left
	BOTH_P1_S1_BR_MD,	//# Block shot/saber bottom right
	BOTH_P1_S1_TL_MD,	//# Block shot/saber top left
	BOTH_P1_S1_TR_MD,	//# Block shot/saber top right
	BOTH_P1_S1_T__MD,	//# Block shot/saber top
	//Dual Saber parry anims MD Mode
	BOTH_P6_S6_BL_MD,	//# Block shot/saber bottom left
	BOTH_P6_S6_BR_MD,	//# Block shot/saber bottom right
	BOTH_P6_S6_TL_MD,	//# Block shot/saber top left
	BOTH_P6_S6_TR_MD,	//# Block shot/saber top right
	BOTH_P6_S6_T__MD,	//# Block shot/saber top
	//SaberStaff parry anims MD Mode
	BOTH_P7_S7_BL_MD,	//# Block shot/saber bottom left
	BOTH_P7_S7_BR_MD,	//# Block shot/saber bottom right
	BOTH_P7_S7_TL_MD,	//# Block shot/saber top left
	BOTH_P7_S7_TR_MD,	//# Block shot/saber top right
	BOTH_P7_S7_T__MD,	//# Block shot/saber top

	BOTH_K1_S1_TL_MD,	//# knockaway saber top left
	BOTH_K1_S1_TR_MD,	//# knockaway saber top right
	...
	BOTH_HANGING,
	BOTH_DEFLECTING,
	BOTH_SABERPULL_HOLD,			//# Use off-hand to do force power.
	...
	PLAYER_SURRENDER_START,	//# arms up
	PLAYER_SURRENDER_STOP,	//# arms back down
