...
void Touch_Item(gentity_t* ent, gentity_t* other, trace_t* trace) {
	...
	if (g_SerenityJediEngineMode->integer && (other->s.number < MAX_CLIENTS || G_ControlledByPlayer(other)))
...
void ClearRegisteredItems( void )
{
	...
	RegisterItem(FindItemForWeapon(WP_MELEE));	//has no item	//has no item
