...
void G_InitCvars( void )
{
	...
	g_saberLockRandomNess = gi.cvar( "g_saberLockRandomNess", "1", CVAR_ARCHIVE );//just for debugging/development, controls frequency of saberlocks
	...
	g_SerenityJediEngineMode = gi.cvar("g_SerenityJediEngineMode", "0", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);//Alternate saber combat system

	g_SaberPerfectBlockingTimerMissile = gi.cvar("g_SaberPerfectBlockingTimerMissile", "750", CVAR_ARCHIVE);//Alternate saber combat system 3 sec

	g_SaberPerfectBlockingTimerEasy = gi.cvar("g_SaberPerfectBlockingTimerEasy", "500", CVAR_ARCHIVE);//Alternate saber combat system 2 sec
	g_SaberPerfectBlockingTimerNormal = gi.cvar("g_SaberPerfectBlockingTimerNormal", "300", CVAR_ARCHIVE);//Alternate saber combat system 1.5 sec
	g_SaberPerfectBlockingTimerHard = gi.cvar("g_SaberPerfectBlockingTimerHard", "150", CVAR_ARCHIVE);//Alternate saber combat system 1 sec

	g_SaberMBlockingTimerwaitEasy = gi.cvar("g_SaberMBlockingTimerwaitEasy", "1000", CVAR_ARCHIVE);//wait time between Mblocks
	g_SaberMBlockingTimerwaitNormal = gi.cvar("g_SaberMBlockingTimerwaitNormal", "2000", CVAR_ARCHIVE);//wait time between Mblocks
	g_SaberMBlockingTimerwaitHard = gi.cvar("g_SaberMBlockingTimerwaitHard", "4000", CVAR_ARCHIVE);//wait time between Mblocks
	...
	g_gundismemberment = gi.cvar("g_gundismemberment", "1", CVAR_ARCHIVE);

	g_update4firststartup = gi.cvar("g_update4firststartup", "1", 0);
...
//			continue;
		...
		if ( i == 0 )
		{
			...
			{
				if (ent->client->ps.blockPoints < BLOCK_POINTS_MAX)
				{
