...
static void		UI_AddPistolSelection(const int weaponIndex, const int ammoIndex, const int ammoAmount, const char* iconItemName, const char* litIconItemName, const char* hexBackground, const char* soundfile);
...
vmCvar_t    ui_update4firststartup;
...
static cvarTable_t cvarTable[] =
{
	...
	{ &ui_char_anim,			"ui_char_anim",			"BOTH_MENUIDLE1", NULL, 0},
	...
	{ &ui_SFXSabers,	        "cg_SFXSabers",     	"4", NULL, CVAR_ARCHIVE },
	...
	//
	{ &ui_SFXSabersGlowSizeEP1,	"cg_SFXSabersGlowSizeEP1",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersCoreSizeEP1,	"cg_SFXSabersCoreSizeEP1",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersGlowSizeEP2,	"cg_SFXSabersGlowSizeEP2",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersCoreSizeEP2,	"cg_SFXSabersCoreSizeEP2",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersGlowSizeEP3,	"cg_SFXSabersGlowSizeEP3",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersCoreSizeEP3,	"cg_SFXSabersCoreSizeEP3",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersGlowSizeSFX,	"cg_SFXSabersGlowSizeSFX",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersCoreSizeSFX,	"cg_SFXSabersCoreSizeSFX",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersGlowSizeOT,	"cg_SFXSabersGlowSizeOT",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersCoreSizeOT,	"cg_SFXSabersCoreSizeOT",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersGlowSizeROTJ,"cg_SFXSabersGlowSizeROTJ",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersCoreSizeROTJ,"cg_SFXSabersCoreSizeROTJ",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersGlowSizeTFA,	"cg_SFXSabersGlowSizeTFA",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersCoreSizeTFA,	"cg_SFXSabersCoreSizeTFA",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersGlowSizeUSB,	"cg_SFXSabersGlowSizeUSB",	"1.0", NULL, CVAR_ARCHIVE },
	{ &ui_SFXSabersCoreSizeUSB,	"cg_SFXSabersCoreSizeUSB",	"1.0", NULL, CVAR_ARCHIVE },

	{ &ui_SerenityJediEngineMode,"g_SerenityJediEngineMode", "0", NULL, CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART },

	{ &ui_char_model_angle, "ui_char_model_angle", "175", NULL, 0 },

	{ &ui_com_outcast, "com_outcast", "0", NULL, CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART},

	{ &ui_update4firststartup, "g_update4firststartup", "1", NULL, 0},
};
...
//			if ( !s_savedata[s_savegame.currentLine].currentSaveFileName)	// No line was chosen
		...
		else if (Q_stricmp(name, "addpistolselection") == 0)
		{
			...
			UI_AddPistolSelection(atoi(weaponIndex), atoi(ammoIndex), atoi(ammoAmount), itemName, litItemName, backgroundName, soundfile);
		}
...
static void	UI_AddPistolSelection(const int weaponIndex, const int ammoIndex, const int ammoAmount, const char* iconItemName, const char* litIconItemName, const char* hexBackground, const char* soundfile)
{
	...
	chosenItemName = "chosenpistol1_icon";
	chosenButtonName = "chosenpistol1_button";
...
static void UI_Removepistolselection(void)
{
	...
	chosenItemName = "chosenpistol1_icon";
	chosenButtonName = "chosenpistol1_button";
	background = uiInfo.selectedPistolWeaponItemName;
...
static void	UI_Normalpistolselection(void)
{
	...
	item = (itemDef_s*)Menu_FindItemByName(menu, "chosenpistol1_icon");
