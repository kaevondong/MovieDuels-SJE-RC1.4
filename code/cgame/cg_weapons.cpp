...
void CG_RegisterWeapon(int weaponNum) {
	...
	case WP_SABER:
		...
		//cgi_S_RegisterSound("sound/weapons/force/ragestart.mp3");
		...
		cgi_S_RegisterSound("sound/weapons/force/stasis.wav");
		//force graphics
...
//		CG_LightningBolt( cent, origin );
	...
	float actualFOV;
	if ((!DoingDashAction) && (cg.snap->ps.forcePowersActive & (1 << FP_SPEED)) && player->client->ps.forcePowerDuration[FP_SPEED])//cg.renderingThirdPerson &&
	{
...
void CG_DrawDataPadWeaponSelect( void )
{
	...
	const short sideMax = 1;	// Max number of icons on the side
