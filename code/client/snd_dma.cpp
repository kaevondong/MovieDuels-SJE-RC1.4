...
#endif
	Com_Printf("----- Genuine SerenitySaberSystems(Solaris Edition)-----\n");
	Com_Printf("----- MovieDuels-----\n");

	Com_Printf("This mod improves the hit detection and alters the saber traces. Additionally, the first part of a swing\n");
	Com_Printf("will now do damage. This allows the beginning of the swing to be blocked/parried. Because of this new\n");
	Com_Printf("early-block system, saber spam or heavy exploits will be less effective. A player can 'deny' an enemy who\n");
	Com_Printf("wildly swings their saber (fans, aggressive wiggle) and will force them to make cleaner, more precise hits.\n");
	Com_Printf("To make up for the beginning of the swing's shortcomings, I added a 50 percent increase to end-phase damage.\n");
	Com_Printf("More damage at the end of the swing should maintain the fast-paced feel of MovieDuels. Well-timed and well-aimed\n");
	Com_Printf("slashes are more effective than on basejka.\n");
	Com_Printf("This could potentially improve the way we play MovieDuels quite a lot. Less spam-friendly, and more accurate\n");
	Com_Printf("hit detection could make the game more fast-paced and controlled.\n");
